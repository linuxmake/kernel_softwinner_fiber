...
//gongpiqiang,添加need_detect项，不使用fex文件中的配置
__camera_list_t camera_list[MAX_CAMERA_LIST_ITEM] = {
    ...
    CAMERA_LIST_ITEM_INIT(gt2005,        2, 1, 0x78, 0, 1, 0, 1, 1, 0, 1),
    ...
    CAMERA_LIST_ITEM_INIT(hi253,         1, 1, 0x40, 1, 0, 0, 1, 1, 0, 0),
    ...
    CAMERA_LIST_ITEM_INIT(gc0309,        1, 1, 0x42, 1, 0, 0, 1, 1, 0, 0),
    ...
    CAMERA_LIST_ITEM_INIT(siv121d,       1, 1, 0x66, 1, 0, 0, 1, 1, 0, 0),
    CAMERA_LIST_ITEM_INIT(gc0328,        1, 1, 0x42, 1, 0, 0, 1, 1, 0, 1),//gongpiqiang+++ add camera
    CAMERA_LIST_ITEM_INIT(gc2235,        1, 1, 0x78, 1, 0, 0, 1, 1, 0, 1),//gongpiqiang+++ add camera
    CAMERA_LIST_ITEM_INIT(sp0718,        1, 1, 0x42, 1, 0, 0, 1, 1, 0, 1), //gongpiqiang+++ add camera
    CAMERA_LIST_ITEM_INIT(sp2518,        1, 1, 0x60, 1, 0, 0, 1, 1, 0, 1), //gongpiqiang+++ add camera   
