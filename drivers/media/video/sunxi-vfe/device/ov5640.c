...
static struct regval_list sensor_sxga_regs[] = { //SXGA: 1280*960 use it to preview
...
static int sensor_set_capture_exposure(struct v4l2_subdev *sd)
{
	...
	capture_Exposure = previewExposure*3/2; 
...
static int sensor_init(struct v4l2_subdev *sd, u32 val)
{
  ...
  //info->stby_mode = HW_STBY;
  //printk(KERN_ERR"Owen: +++++stby_mode = %d,  init_first_flag = %d +++++\n",info->stby_mode,info->init_first_flag);
  ...
  //  return 0;
  //} 
  //printk(KERN_ERR"Owen: ++++++++init ov5640++++++\n");
  info->focus_status = 0;
  info->low_speed = 0;
  info->width = 0;
  info->height = 0;
