...
//sat
#define  SP2518_P0_0xd4  0x70  //0x77
#define  SP2518_P0_0xd9  0x70  //0x77
//auto lum
#define SP2518_NORMAL_Y0ffset  0x20 //0x10
...
static struct regval_list sensor_hongyun_regs[] = {
	//SI50_SP2518 V1.3
	//Eclk=24M,pclk=24M, 
	//UXGA scale to 800x600 14-8fps
	{0xfd,0x00},
	{0x0e,0x01},
	{0x0f,0x2f},
	{0x10,0x2e},
...
//ae setting
	...
	{0x59,0x10},
	//R\BÍ¨µÀ¼äÆ½»¬
	{0x5a,0xd0},// c0raw_rb_fac_outdoor
	{0xc4,0xe0},//60raw_rb_fac_indoor
	{0x43,0xe0},//40raw_rb_fac_dummy
	{0xad,0x60},//raw_rb_fac_low
	
	//Gr¡¢Gb Í¨µÀÄÚ²¿Æ½»¬
	{0x4f,0xd0},//raw_gf_fac_outdoor
	{0xc3,0xe0},//60raw_gf_fac_indoor
	{0x3f,0xe0},//40raw_gf_fac_dummy
	{0x42,0x60},//raw_gf_fac_low
	{0xc2,0x15},
				
	//Gr¡¢GbÍ¨µÀ¼äÆ½»¬
	{0xb6,0x90},//c0raw_gflt_fac_outdoor
	{0xb7,0xa0},//60raw_gflt_fac_normal
	{0xb8,0x50},//40raw_gflt_fac_dummy
	{0xb9,0x30},//raw_gflt_fac_low
	//Gr¡¢GbÍ¨µÀãÐÖµµ
	{0xfd,0x01},
	{0x50,0x0a},//10raw_grgb_thr
	{0x51,0x0a},//10
	{0x52,0x0c},
	{0x53,0x0c},
	{0xfd,0x00},	
...
//ae setting
	...
	{0x2f,0x00},
	#endif
	//24M 2x 8.5fps 50HZ   //PZT 2013-10-16
		{0xfd,0x00},
	{0x03,0x02},
	{0x04,0x9a},
	{0x05,0x00},
